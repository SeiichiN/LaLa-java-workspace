...
public class Judge {
	...
	public void judgement(Character c) {
		array[0] = new Goblin("ゴブリン", 'A');
		array[1] = new Goblin("ゴブリン", 'B');
		array[2] = new DeathBat("デスバット", 'A');
		array[3] = new DeathBat("デスバット", 'B');
		array[4] = new Matango("マタンゴ", 'A');
		array[5] = new Matango("マタンゴ", 'B');
		
			for(Monster m : array) { m.autoMove();}
				Monster m0 = (Monster)Array.get(array, 0);
				Monster m1 = (Monster)Array.get(array, 1);
				Monster m2 = (Monster)Array.get(array, 2);
				Monster m3 = (Monster)Array.get(array, 3);
				Monster m4 = (Monster)Array.get(array, 4);
				Monster m5 = (Monster)Array.get(array, 5);
